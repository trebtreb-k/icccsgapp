  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__["c"].getBoolean('_testing')) {
          __webpack_require__.e(/*! import() */ 91).then(__webpack_require__.bind(null, /*! ./tap-click-7ddcdebb.js */ "r+KJ")).then(module => module.startTapClick(_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__["c"]));
        }
        if (_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__["c"].getBoolean('statusTap', isHybrid)) {
          __webpack_require__.e(/*! import() */ 89).then(__webpack_require__.bind(null, /*! ./status-tap-9cb487b1.js */ "eVst")).then(module => module.startStatusTap());
        }
        if (_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__["c"].getBoolean('inputShims', needInputShims())) {
          __webpack_require__.e(/*! import() */ 43).then(__webpack_require__.bind(null, /*! ./input-shims-ce03ee9f.js */ "aYbf")).then(module => module.startInputShims(_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__["c"]));
        }
        ...
        if (typeof window !== 'undefined') {
          __webpack_require__.e(/*! import() */ 87).then(__webpack_require__.bind(null, /*! ./keyboard-5742b5da.js */ "nGaW")).then(module => module.startKeyboardAssist(window));
        }
        __webpack_require__.e(/*! import() */ 42).then(__webpack_require__.bind(null, /*! ./focus-visible-f4ad4f1a.js */ "Tsnu")).then(module => module.startFocusVisible());
      });
    }
  }
  render() {
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await __webpack_require__.e(/*! import() */ 2).then(__webpack_require__.bind(null, /*! ./swipe-back-1bbd08e0.js */ "TWyq"))).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
        this.ani.onFinish(() => {
          this.gestureOrAnimationInProgress = false;
          if (this.swipeHandler) {
